  ...
  return (
    ...
    >
      ...
      <div className="text-center flex flex-col items-center justify-center h-3/4 max-w-2xl mx-auto gap-4 text-white">
        ...
        <button
          type="button"
          class="text-white bg-[#0075EB] hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-full px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 text-[18px]"
        >
          Download Sekarang!
        </button>
      </div>
